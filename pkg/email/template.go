...
func resetPasswordEmailTemplate(toEmail, link string) string {
	return fmt.Sprintf(`<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:40px 40px 24px;">
                            ...
                            <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#6b7280;">
                                We received a request to reset your WorkAble account password. Click the button below to set a new password. This link will expire in <strong>15 minutes</strong>.
                            </p>
                    ...
                    <tr>
                        <td style="padding:24px 40px 32px;">
                            <p style="margin:0;font-size:12px;color:#9ca3af;line-height:1.6;">
                                If you did not request a password reset, you can safely ignore this email. Your password will not be changed.<br/>
                                This email was sent to <strong>%s</strong>.
                            </p>
                        </td>
                    </tr>
