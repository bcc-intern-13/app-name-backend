...
type Application struct {
	...
	InterviewDate   *time.Time `gorm:"column:interview_date;type:timestamp" json:"interview_date"`
	Interviewer     string     `gorm:"column:interviewers;type:varchar(20);" json:"interviewer"`
